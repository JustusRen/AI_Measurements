...
if __name__ == "__main__":
    ...
    for i in range(6):
        ...
        print('Incremental PCA matrix shape:', tfidf_pca.shape)
        ...
        plt.title(f'Incremental PCA of TF-IDF Vectors (n={SAMPLE_SIZE}, iteration={i + 1})')
        plt.legend()
    ...
    for i in range(6):
        ...
        print('Incremental PCA matrix shape:', bow_pca.shape)
        ...
        plt.title(f'Incremental PCA of BOW Vectors (n={SAMPLE_SIZE}, iteration={i + 1}')
        plt.legend()
